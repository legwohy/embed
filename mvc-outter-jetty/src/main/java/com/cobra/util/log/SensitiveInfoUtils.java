...
public class SensitiveInfoUtils {
    ...
    /**
     * [身份证号] 显示最后四位，其他隐藏。共计18位或者15位。<例子：342623************>
     *
     * @param idCardNum
     * @return
     */
     ...
     * @return
     */
    public static String addressInfo(String fullName) {
        if (StringUtils.isBlank(fullName)) {
            return "";
        }
        return StringUtils.left(fullName, 4).concat(StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(fullName, 4),StringUtils.length(fullName), "*"), "****"));
    }
}
